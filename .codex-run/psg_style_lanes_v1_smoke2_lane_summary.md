...
## Lane Outputs
- patchwork_lock: selected=6, matched=6, status=ok, csv=F:\Unityproject\ArrowLevel-Hand\.codex-run\psg_style_lanes_v1_smoke2_lane_patchwork_lock_keep.csv
  - style=lock_buckle:6
...
- core_burst: selected=6, matched=6, status=ok, csv=F:\Unityproject\ArrowLevel-Hand\.codex-run\psg_style_lanes_v1_smoke2_lane_core_burst_keep.csv
  - style=core_burst:6
...
- dense_weave: selected=3, matched=3, status=ok, csv=F:\Unityproject\ArrowLevel-Hand\.codex-run\psg_style_lanes_v1_smoke2_lane_dense_weave_keep.csv
  - style=dense_weave:3
  - chain=short_patchwork:2;woven_medium:1
  - flow=staged_unlock:2;region_alternating_flow:1
  - risk=watch:2;clean:1
- flow_spread: selected=6, matched=6, status=ok, csv=F:\Unityproject\ArrowLevel-Hand\.codex-run\psg_style_lanes_v1_smoke2_lane_flow_spread_keep.csv
...
- staged_unlock: selected=8, matched=9, status=ok, csv=F:\Unityproject\ArrowLevel-Hand\.codex-run\psg_style_lanes_v1_smoke2_lane_staged_unlock_keep.csv
  - style=lock_buckle:4;dense_weave:2;core_burst:2
  - chain=short_patchwork:4;lock_cluster:3;woven_medium:1
  - flow=staged_unlock:7;local_collapse:1
  - risk=watch:3;high_risk:3;clean:2
